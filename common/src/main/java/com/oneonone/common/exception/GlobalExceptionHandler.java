...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleValidationException(MethodArgumentNotValidException ex) {
        ...
        return ResponseEntity
                .badRequest()
                .body(ApiResponse.error(CommonErrorCode.VALIDATION_ERROR, errors.toString()));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleDomainException(RuntimeException e) {
        ...
        return ResponseEntity
                .status(CommonErrorCode.SERVICE_ERROR.getHttpStatus())
                .body(ApiResponse.error(CommonErrorCode.SERVICE_ERROR, e.getMessage()));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleJsonParseException(HttpMessageNotReadableException e) {
        ...
        return ResponseEntity
                .badRequest()
                .body(ApiResponse.error(CommonErrorCode.VALIDATION_ERROR, "형식을 확인해주세요."));
    }
